#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Tests the Threaded Turbinia processor."""
...
from dftimewolf.lib.processors import turbinia_gcp_tam as turbinia_gcp
...
class TurbiniaProcessorThreadedTest(unittest.TestCase):
  """Tests for the Turbinia processor."""

  def testInitialization(self):
    """Tests that the processor can be initialized."""
    test_state = state.DFTimewolfState(config.Config)
    turbinia_processor = turbinia_gcp.TurbiniaGCPProcessorThreaded(test_state)
  ...
  @mock.patch('dftimewolf.lib.processors.turbinia_gcp_tam.turbinia_config')
  @mock.patch('turbinia.client.get_turbinia_client')
  # pylint: disable=invalid-name
  ...
  def testProcess(self,
    ...
    test_container = containers.GCEDisk('disk-1')

    turbinia_processor.PreProcess()
    turbinia_processor.Process(test_container)
