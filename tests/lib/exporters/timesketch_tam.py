...
from dftimewolf.lib.exporters import timesketch_tam as timesketch
from dftimewolf.lib import errors


class TimesketchExporterThreadedTest(unittest.TestCase):
  """Tests for the Threaded Timesketch exporter."""

  def testInitialization(self):
    """Tests that the processor can be initialized."""
    test_state = state.DFTimewolfState(config.Config)
    timesketch_exporter = timesketch.TimesketchExporterThreaded(test_state)
  ...
  def testNewSketchCreation(self, mock_GetApiClient, _):
    ...
    self.assertEqual(report.module_name, 'TimesketchExporterThreaded')
    self.assertEqual(
        report.text,
