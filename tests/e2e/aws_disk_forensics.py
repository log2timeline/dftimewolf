...
RECIPE = {
  ...
  'args': [
    ...
    ['aws_bucket', 'AWS bucket for image storage.', None, {'format': 'regex', 'comma_separated': False, 'regex': r'^(s3:\/\/)?[0-9a-z][-\\.0-9a-z]{1,61}[0-9a-z]$'}],
    ['gcp_bucket', 'GCP bucket for image storage.', None, {'format': 'regex', 'comma_separated': False, 'regex': r'^(gs:\/\/)?[0-9a-z][-\\.0-9a-z_]{1,61}[0-9a-z]$'}],
