...
_AUDITLOG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_response_items', full_name='google.cloud.audit.AuditLog.num_response_items', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.cloud.audit.AuditLog.status', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='authentication_info', full_name='google.cloud.audit.AuditLog.authentication_info', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='authorization_info', full_name='google.cloud.audit.AuditLog.authorization_info', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='request_metadata', full_name='google.cloud.audit.AuditLog.request_metadata', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='request', full_name='google.cloud.audit.AuditLog.request', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='response', full_name='google.cloud.audit.AuditLog.response', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='service_data', full_name='google.cloud.audit.AuditLog.service_data', index=10,
...
_AUDITLOG.fields_by_name['status'].message_type = google_dot_rpc_dot_status__pb2._STATUS  # pyrefly: ignore[missing-attribute]
...
_AUDITLOG.fields_by_name['request'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT  # pyrefly: ignore[missing-attribute
_AUDITLOG.fields_by_name['response'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT  # pyrefly: ignore[missing-attribute
_AUDITLOG.fields_by_name['service_data'].message_type = google_dot_protobuf_dot_any__pb2._ANY  # pyrefly: ignore[missing-attribute
