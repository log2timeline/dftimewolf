...
class AzureCollector(module.BaseModule):
  ...
  def __init__(self,
    ...
    self.source_account: account.AZAccount = None  # pyrefly: ignore=[bad-assignment]
    ...
    self.analysis_vm: compute.AZComputeVirtualMachine = None  # pyrefly: ignore=[bad-assignment]
