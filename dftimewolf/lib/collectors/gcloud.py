...
class GoogleCloudCollector(module.BaseModule):
  ...
  def SetUp(self,
    ...
    This method creates and starts an analysis VM in the analysis project.
...
class GCEDiskCollector(GoogleCloudCollector):
  """"""
  ...
  def SetUp(self,
    ...
    * if all_disks is set to True, it will select all disks in the project
    ...
    # Create analysis VM
    super(GCEDiskCollector, self).SetUp(analysis_project_name,
                                        remote_project_name,
