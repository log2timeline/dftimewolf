...
from dftimewolf.lib import module, opentelemetry, timesketch_utils
...
class TimesketchExporter(module.ThreadAwareModule):
  ...
  def _CreateSketch(
    ...
    with opentelemetry.start_span('Timesketch.CreateSketch', {'sketch_name': sketch_name}):
  ...
  def _WaitForTimelines(self) -> None:
    ...
    """
    with opentelemetry.start_span('Timesketch.WaitForTimelines', {'sketch_id': self.sketch_id}):
  ...
  def _RunAnalyzers(self, timeline_name: str) -> None:
    ...
    try:
      with opentelemetry.start_span('Timesketch.RunAnalyzers', {
  ...
  def Process(self, container: containers.File) -> None:  # pyrefly: ignore[bad-override]
    ...
    with opentelemetry.start_span('Timesketch.Upload', {
