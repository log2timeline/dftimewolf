...
class TimesketchExporterThreaded(module.ThreadAwareModule):
  ...
  def __init__(self,
    ...
    super(TimesketchExporterThreaded, self).__init__(
  ...
  def Process(self, container: containers.File) -> None:
    ...
    report_container = containers.Report(
        module_name='TimesketchExporterThreaded',
        text=message,
...
modules_manager.ModulesManager.RegisterModule(TimesketchExporterThreaded)
