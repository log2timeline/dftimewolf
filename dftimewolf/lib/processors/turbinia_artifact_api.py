...
class TurbiniaArtifactProcessorAPI(TurbiniaProcessorBaseAPI,
  ...
  def SetUp(
      ...
      turbinia_zone: str, turbinia_api: str, output_directory: str, incident_id: str,
      sketch_id: int) -> None:
    ...
    self.TurbiniaSetUp(
        project, turbinia_auth, turbinia_recipe, turbinia_zone, turbinia_api, incident_id,
        sketch_id)
...
modules_manager.ModulesManager.RegisterModule(TurbiniaArtifactProcessorAPI)
