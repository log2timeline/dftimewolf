...
class TurbiniaGCPProcessorLegacy(
    TurbiniaProcessorBaseLegacy, module.ThreadAwareModule):
  ...
  def __init__(self,
    ...
    TurbiniaProcessorBaseLegacy.__init__(self, self.logger)
...
modules_manager.ModulesManager.RegisterModule(TurbiniaGCPProcessorLegacy)
