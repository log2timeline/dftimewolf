...
L2TBINARIES_DEPENDENCIES="certifi chardet idna pytz requests urllib3";

L2TBINARIES_TEST_DEPENDENCIES="funcsigs mock pbr six";

PYTHON2_DEPENDENCIES="python-certifi python-chardet python-idna python-requests python-tz python-urllib3";
